...
def test_designed_direction_lies_in_the_kernel_of_the_gramian() -> None:
    ...
    assert np.linalg.norm(action) < 1e-10
...
def test_a_direction_orthogonal_to_the_blind_spot_is_not_in_the_kernel() -> None:
